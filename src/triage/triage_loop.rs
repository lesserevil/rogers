...
pub struct TriageIssue {
    ...
    /// GitHub issue URL (for task references)
...
pub enum TriageAction {
    ...
    WillNotDo,
    /// Human has applied ready-for-work - breakdown initiated (tasks filed)
    BreakdownComplete,
...
/// - Doc-gap filing: file a chore task if no answer found
///
...
"#;
    ...
    fn test_ready_for_work_with_epic_scale_issue() {
        // Epic-scale issue (multi-area) triggers breakdown with child tasks
        let epic_body = r#"
## Use Case
Full-stack feature
